...
if __name__ == "__main__":
    ...
    # --- Active Zone Definitions (Relative to Video Dimensions) ---
    # NOTE: Define these based on the *expected* resolution of your input videos.
    # Example dimensions provided - ADJUST THESE BASED ON YOUR VIDEOS
